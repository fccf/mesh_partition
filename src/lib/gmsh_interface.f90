...
module gmsh_interface
  ...
  contains
    ...
    procedure :: get_eni2  => msh_get_eni2
    procedure :: get_eni1  => msh_get_eni1
    procedure :: get_fni2  => msh_get_fni2
    procedure :: get_fni1  => msh_get_fni1
...
contains
  ...
  !=============================================================================
  pure function msh_get_eni2(this) result(eni)
    class(msh_file), intent(in) :: this
  ...
  end function msh_get_eni2
  !=============================================================================
  subroutine msh_get_eni1(this, eptr, eind)
    class(msh_file), intent(in) :: this
  ...
  end subroutine msh_get_eni1
  !=============================================================================
  pure function msh_get_fni2(this) result(fni)
    class(msh_file), intent(in) :: this
  ...
  end function msh_get_fni2
  !=============================================================================
  subroutine msh_get_fni1(this, fptr, find)
    class(msh_file), intent(in) :: this
